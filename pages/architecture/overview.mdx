...
This page has been moved to provide better organization.

Please visit the new [System Overview](/architecture/system-overview) page for comprehensive architecture documentation.

## Quick Navigation

- **[System Overview](/architecture/system-overview)** - High-level architecture and data flow
- **[CoAP Bridge Deployment](/architecture/coap-bridge)** - Fly.io deployment procedures  
- **[Protocol Specifications](/architecture/protocol-specs)** - Protobuf message formats
- **[Dashboard Integration](/architecture/dashboard)** - React frontend architecture
