...
The `ingest-sensor-data` Edge Function is the primary data ingestion endpoint that processes IoT device data forwarded from the Fly.io CoAP bridge server.

**Endpoint**: `https://cdwtsrzshpotkfbyyyjk.supabase.co/functions/v1/ingest-sensor-data`  
**Method**: `POST`  
